...
export PYTHONPATH="."
gpu_id=0
cmd="python3 trainer.py --base_output_dir $base_output_dir --path_length $path_length --hidden_size $hidden_size --embedding_size $embedding_size \
    ...
    --nell_evaluation $nell_evaluation --learning_rate $learning_rate"
